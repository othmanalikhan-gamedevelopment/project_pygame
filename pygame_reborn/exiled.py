...
class Game():
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode(res.DEFAULTSCREENSIZE,
                                              pygame.RESIZABLE)
    ...
    def eventHandle(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                self.running = False
        #
        # if event.type == res.CHANGEPLAYER:
    ...
    def run(self):
        ...
        self.menu.changeState("splash")    # Launches the game's splash menu

        while self.running:

            self.clock.tick(res.GAMEFPS)
...
if __name__ == "__main__":
    ...
    #     print("An unexpected error has occured: {}".format(e))
    #     sys.exit()


# No sense of world if background is just blue (and confined to a box)
# Start screen artwork
# inGame sound effects
# Main character vs background colour
# inGame camera
#
